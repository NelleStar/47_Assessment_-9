...
class SnackOrBoozeApi {
  static async getItems(foodType) {
    const result = await axios.get(`${BASE_API_URL}/${foodType}`);
    return result.data;
  }

  static async addItem(foodType, newItem) {
    const response = await axios.post(`${BASE_API_URL}/${foodType}`, newItem);
